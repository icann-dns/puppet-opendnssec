...
class opendnssec (
  ...
  Stdlib::Syslogfacility        $logging_facility,
  ...
  Stdlib::Unixpath              $repository_module,
  ...
  Stdlib::Unixpath              $mysql_sql_file,
  Stdlib::Unixpath              $base_dir,
  Stdlib::Unixpath              $policy_file,
  Stdlib::Unixpath              $zone_file,
  Stdlib::Unixpath              $tsigs_dir,
  Stdlib::Unixpath              $remotes_dir,
  Stdlib::Unixpath              $xsl_file,
  Stdlib::Unixpath              $sqlite_file,
  Stdlib::Unixpath              $working_dir,
  Stdlib::Unixpath              $signconf_dir,
  Stdlib::Unixpath              $signed_dir,
  Stdlib::Unixpath              $unsigned_dir,
  Stdlib::Unixpath              $ksmutil_path,
  Stdlib::Unixpath              $enforcer_path,
